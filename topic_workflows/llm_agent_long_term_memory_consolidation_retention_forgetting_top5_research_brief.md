...
- Topic: `LLM agent long-term memory consolidation retention forgetting`
...
- Evidence dossier: `/home/tao/ai4research/topic_workflows/llm_agent_long_term_memory_consolidation_retention_forgetting_top5_evidence_dossier.md`
- Ready paper count: `5`
- Top papers requested: `5`

## One-screen Summary

- This brief is derived from the existing evidence dossier and does not add unsupported claims.
- The current workflow topic is `LLM agent long-term memory consolidation retention forgetting`.
- The workflow currently contains `5` ready papers for evidence-backed review.
